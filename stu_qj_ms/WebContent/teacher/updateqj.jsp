...
<html>
  ...
  <body  background="d.jpg" >
    ...
    <form action="servlet/updateqj?k_id=<%=kid %>" method="post" name="updateform" onSubmit="return isValid()">
        <table width="55%" align="center" border="1">
           ...
           <tr>
            ...
            <tr>
             ...
             <td width="54%">&nbsp;&nbsp;&nbsp;
             <input type="radio" name="ison" value="0" <%=rs.getInt("ison")==0?"checked":"" %>>不批准
	<input type="radio" name="ison" value="1" <%=rs.getInt("ison")==1?"checked":"" %>>批准<br><br>
           </tr>								
