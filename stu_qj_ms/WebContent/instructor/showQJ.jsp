...
<html>
 ...
 <body  background="b.jpg" >
   ...
   String cid="",courseTime="",ktype="",tid="",fid="",content="",redate="",isfu="",sid="";
   int days,kid;
  ...
  <div align="center">
    <table width="60%"  border="1">
      ...
      <tr> 
        ...
        <th align="center">辅导员</th>
          <th align="center">备注</th>
         
          <th align="center">辅导员意见</th>
           <th align="center">附件</th>
           <td align="center">基本操作</td>      
      </tr>
      <%ResultSet  rs=a.getQingJia2(f_id);
      while(rs.next()){
      ...
      <tr>
       ...
       <td align="center"><%=sid%></td>
        ...
        <td align="center"><a href="servlet/delqj2?k_id=<%=kid%>" title="删除请假">查看详情</a></td>
         <td align="center"><a href="/stu_qj_ms/instructor/updateqj.jsp?k_id=<%=kid%>" title="修改信息">审批</a></td>  
        <td align="center"><a href="servlet/delqj2?k_id=<%=kid%>" title="删除请假">删除</a></td>
      <%} %>
      <%} %>
      <%} %>
      <%} %>
