...
<html>
  ...
  <body bgcolor="#CCCCCC">
    ...
    <form action="servlet/updateqj1?k_id=<%=kid %>" method="post" name="updateform" onSubmit="return isValid()">
        <table width="55%" align="center" border="1">
           <tr>
             <td width="36%" align="center">课程号</td>
             <td width="54%">&nbsp;&nbsp;&nbsp;<input type="text" name="cid" value=<%=rs.getString("cid") %> size="16"></td>
           </tr>
           <tr>
             <td width="36%" align="center">请假时间</td>
             <td width="54%">&nbsp;&nbsp;&nbsp;<input type="text" name="courseTime" value=<%=rs.getString("courseTime") %> size="16">(必填)</td>
           </tr>
           <tr>
             <td width="36%" align="center">请假类型</td>
             <td width="54%">&nbsp;&nbsp;&nbsp;<input type="text" name="ktype" value=<%=rs.getString("ktype") %> size="16"></td>
           </tr>
           <tr>
             <td width="36%" align="center">请假天数</td>
             <td width="54%">&nbsp;&nbsp;&nbsp;<input type="text" name="days" value=<%=rs.getString("days") %> size="16"></td>
           </tr>
           <tr>
             <td width="36%" align="center">请假日期</td>
             <td width="54%">&nbsp;&nbsp;&nbsp;<input type="text" name="redate" value=<%=rs.getString("redate") %> size="16"></td>
           </tr>
           <tr>
             <td width="36%" align="center">任课教师</td>
             <td width="54%">&nbsp;&nbsp;&nbsp;<input type="text" name="tid" value=<%=rs.getString("tid") %> size="16">(必填)</td>
           </tr>
           <tr>
             <td width="36%" align="center">辅导员</td>
             <td width="54%">&nbsp;&nbsp;&nbsp;<input type="text" name="fid" value=<%=rs.getString("fid") %> size="16">(必填)</td>
           </tr>
            <tr>
             <td width="36%" align="center">备注</td>
             <td width="54%">&nbsp;&nbsp;&nbsp;<input type="text" name="content" value=<%=rs.getString("content") %> size="16">(必填)</td>
           </tr>
