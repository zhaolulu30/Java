...
<html>
  ...
  <body bgcolor="#CCCCCC">
    <%String s_password=(String)session.getAttribute("password");
    String s_id=(String)session.getAttribute("id");%>
   <br>
   <center><font size=6 color="blue">修改密码</font></center><br>
   <form name="form1" method="post" action="servlet/updateSpassword">
    <input type="hidden" name="id" value="<%=s_id %>">
     <input type="hidden" name="password" value="<%=s_password %>">
