...
/**
 * Servlet implementation class updateSpassword
 */
@WebServlet("/servlet/updateSpassword")
public class updateSpassword extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			if(!old.equals(s_password)&!old.equals(""))
				...
				String sql="update student set password='"+pw1+"'where id='"+s_id+"'";
